...
The observer audits the frame. (See OWL-4-METACOGNITIVE for the normative phrasing rule; the canonical sentence for METACOGNITIVE — set in v2.0.0 and carried through v3.0.1 — is *"The observer audits the frame,"* with the warmer explanatory variant *"Thinking examines its own frame."*)
