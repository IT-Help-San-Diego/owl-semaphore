...
CITING_DOI = CONCEPT_DOI  # DOI used to cite v2.0.2; concept DOI by design
...
def build_typst_document(doc: dict, body_typst: str) -> str:
    ...
    banner_tuple = (
        ...
        f"PREVIOUS-VERSION-DOI={PREVIOUS_VERSION_DOI}"
    )
...
#align(center)[
  ...
  #text(size: 8.5pt, fill: luma(120))[
    ...
    PREVIOUS-VERSION-DOI {PREVIOUS_VERSION_DOI} (v2.0.1) #h(12pt) PRIOR-V2.0.0-DOI {PRIOR_V200_DOI} \\
...
#align(center)[
  ...
  #text(size: 8pt, fill: luma(140))[
    ...
    Concept DOI {CONCEPT_DOI} · v1.2.0 DOI {PRIOR_V120_DOI} · v2.0.0 DOI {PRIOR_V200_DOI} · v2.0.1 DOI {PREVIOUS_VERSION_DOI} \\
