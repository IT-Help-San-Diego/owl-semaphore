...
PUBLISHED_VERSION_DOI = "10.5281/zenodo.19474599"  # v1.2.0 (most recent published)
VERSION_DOI_RC = "TBD_BY_ZENODO_ON_RELEASE"
LICENSE = "CC-BY-4.0"
...
def build_typst_document(doc: dict, body_typst: str) -> str:
    ...
    banner_tuple = (
        ...
        f"RC-VERSION-DOI={VERSION_DOI_RC}"
    )
...
#align(center)[
  ...
  #text(size: 8.5pt, fill: luma(120))[
    ...
    PUBLISHED-VERSION-DOI {PUBLISHED_VERSION_DOI} (v1.2.0) #h(12pt) RC-VERSION-DOI {VERSION_DOI_RC} \\
