...
## (Informative companion to the System Specification — v3.0.1)
...
- Version-specific DOI (v3.0.1; the citing DOI for this release, reserved on Zenodo): https://doi.org/10.5281/zenodo.21524422
- Concept DOI (all versions, resolves to the latest published version): https://doi.org/10.5281/zenodo.19473697
- Previous published version DOI (v3.0.0): https://doi.org/10.5281/zenodo.20468727
- Earlier published version DOI (v2.0.2): https://doi.org/10.5281/zenodo.20433053
